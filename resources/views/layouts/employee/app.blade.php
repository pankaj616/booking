...
<body>
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="list-group list-group-flush">
        ...
        <a href="{{ route('user.profile') }}" class="list-group-item list-group-item-action bg-light">Profile</a>
        <a href="{{ route('user.leaves') }}" class="list-group-item list-group-item-action bg-light">My Leaves</a>
    </div>
    </div>
    <!-- /#sidebar-wrapper -->
